...
describe("IdeaCard", () => {
  it("renders author when present", () => {
    render(
      <IdeaCard idea={{ slug: "x", title: "Formação docente", excerpt: null, category_name: null, author: "Autor Exemplo" }} />
    );
    expect(screen.getByText("Por Autor Exemplo")).toBeInTheDocument();
  });
});
