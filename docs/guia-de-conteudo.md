# Guia de Conteúdo — Referência de Campos do Admin
...
- **Autor:** só existe em Notícias e Ideias. Pode deixar "Redação" ou o nome de quem assina, dependendo se é uma fala pessoal ou uma nota mais jornalística.
...
| Campo | O que é | Como preencher |
|---|---|---|
| Título | Nome de exibição | Ex.: nome público do cliente |
...
| Campo | Como preencher |
|---|---|
| Nome do portal | Ex.: nome público do cliente |
